		...
		<div id="list-fileUpload" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'fileUpload.name.label', default: 'Name')}" />
				...
				<g:each in="${fileUploadInstanceList}" status="i" var="fileUploadInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${fileUploadInstance.id}">${fieldValue(bean: fileUploadInstance, field: "name")}</g:link></td>
