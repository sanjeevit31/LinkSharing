    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="lastUpdated"
                              title="${message(code: 'topic.last Updated.label', default: 'Last Updated')}"/>

            <th><g:message code="topic.user.label" default="New Users"/></th>

            <g:sortableColumn property="visibility"
                              title="${message(code: 'topic.visibility.label', default: 'Visibility')}"/>
            <th><g:message code="topic.user.label" default="Resources"/></th>
        ...
        <g:each in="${topic}" status="i" var="topicInstance">
            ...
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:textArea name="semmery" value="${topicInstance.summery}" style="width:160px;height: 50px"
                                readonly=""/></td>
