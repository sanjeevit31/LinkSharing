<%@ page import="com.linksharing.State" %>
...
<div class="fieldcontain ${hasErrors(bean: stateInstance, field: 'country', 'error')} required">
	...
	<g:select id="country" name="country.id" from="${com.linksharing.Country.list()}" optionKey="id" required="" value="${stateInstance?.country?.id}" class="many-to-one"/>
