...
<body class="sidebar-wide">
	...
	<div class="navbar navbar-inverse" role="navigation">
		<div class="navbar-header">
			<g:link class="navbar-brand" controller="user" action="userDashBoard"><img src="${resource(dir: 'images/bootstrap',file: 'logo.png')}" alt="Link Sharing" title="Link Sharing"></g:link>
						...
						<div class="block">
							<div class="chat-member-heading clearfix">
								...
								<div class="pull-right">
									<a href="#" class="btn btn-warning btn-icon btn-xs"><i class="icon-plus-circle"></i></a>
								</div>
                        	</div>
					    	<ul class="message-list">
					    		...
					    		<li>
					            	<div class="clearfix">
										...
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#john_doe"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>
					    		...
					    		<li>
					            	<div class="clearfix">
										...
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#barbara_madison"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>
					    		...
					    		<li>
					            	<div class="clearfix">
										...
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#malik_smitsons"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>
					    		...
					    		<li>
					            	<div class="clearfix">
										...
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#barnaba_pall"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>
					    		...
					    		<li class="message-list-header">Office team</li>

					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="http://placehold.it/300" alt=""></a>
											<h6>Xenia Robson <span class="status status-success"></span> <small>&nbsp; /&nbsp; Wed developer</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#xenia_robson"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="xenia_robson">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="http://placehold.it/300" alt=""></a>
					                            <div class="message-body">
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="http://placehold.it/300" alt=""></a>
											<h6>Michael Carlson <span class="status status-warning"></span> <small>&nbsp; /&nbsp; UI expert</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#michael_carlson"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="michael_carlson">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="http://placehold.it/300" alt=""></a>
					                            <div class="message-body">
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="http://placehold.it/300" alt=""></a>
											<h6>Duke Aaron <span class="status status-danger"></span> <small>&nbsp; /&nbsp; Engineer</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#duke_aaron"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="duke_aaron">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="http://placehold.it/300" alt=""></a>
					                            <div class="message-body">
