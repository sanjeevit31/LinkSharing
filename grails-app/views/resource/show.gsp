...
<div id="show-resource" class="content scaffold-show" role="main">
    ...
    <ol class="property-list resource">
        ...
        <g:if test="${resourceInstance?.heading}">
            <li class="fieldcontain">
                <span id="heading-label" class="property-label"><g:message code="resource.heading.label"
                                                                           default="Heading"/></span>

                <span class="property-value" aria-labelledby="heading-label"><g:fieldValue bean="${resourceInstance}"
                                                                                           field="heading"/></span>
        ...
        <g:if test="${resourceInstance?.new}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="new-label"><g:link controller="user" action="show"
                                                                                 id="${resourceInstance?.new?.id}">${resourceInstance?.new?.encodeAsHTML()}</g:link></span>
        ...
        <g:if test="${resourceInstance?.type}">
            <li class="fieldcontain">
                <span id="type-label" class="property-label"><g:message code="resource.type.label"
                                                                        default="Type"/></span>

                <span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${resourceInstance}"
                                                                                        field="type"/></span>
        ...
        <g:if test="${resourceInstance?.url_path}">
            <li class="fieldcontain">
                <span id="url_path-label" class="property-label"><g:message code="resource.url_path.label"
                                                                            default="Urlpath"/></span>

                <span class="property-value" aria-labelledby="url_path-label"><g:fieldValue bean="${resourceInstance}"
                                                                                            field="url_path"/></span>
    ...
    <g:if test="${(resourceInstance.new.emailId) == (User.get(session.userId).emailId)}">
        <g:form url="[resource: resourceInstance, action: 'delete']" method="DELETE">
            <fieldset class="buttons">
                <g:link class="edit" action="edit" resource="${resourceInstance}"><g:message
