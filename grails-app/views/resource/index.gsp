...
<div id="list-resource" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="url_path"
                              title="${message(code: 'resource.url_path.label', default: 'Urlpath')}"/>
        ...
        <g:each in="${resourceInstanceList}" status="i" var="resourceInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${resourceInstance.id}">${fieldValue(bean: resourceInstance, field: "heading")}</g:link></td>
