...
<div id="list-user" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="firstName" title="${message(code: 'user.firstName.label', default: 'Fname')}"/>

            <g:sortableColumn property="lastName" title="${message(code: 'user.lastName.label', default: 'Lname')}"/>

            <g:sortableColumn property="emailId" title="${message(code: 'user.emailId.label', default: 'Emailid')}"/>

            <g:sortableColumn property="password" title="${message(code: 'user.password.label', default: 'Password')}"/>

            <g:sortableColumn property="mobile" title="${message(code: 'user.mobile.label', default: 'Mob')}"/>
